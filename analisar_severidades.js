...
workbook.xlsx.readFile(SOURCE_FILE)
    .then(function () {
        ...
        while (i <= worksheet.rowCount) {
            ...
            var celula_nome = worksheet.getCell(CREATED_BY_COLUMN + i).value
            if (celula_nome != null) {
                if (listPessoas.indexOf(celula_nome.trim().toLowerCase()) == -1) {
                    listPessoas.push(celula_nome.trim().toLowerCase())
                }
            }
        ...
        console.log(listPessoas.length, listPessoas[4])
